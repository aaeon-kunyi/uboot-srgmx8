...
#ifndef __IMX8MM_BSE_H
#define __IMX8MM_BSE_H
...
#define JAILHOUSE_ENV \
    "jh_clk= \0 " \
    "jh_mmcboot=mw 0x303d0518 0xff; setenv fdt_file imx8mm-bse-root.dtb;" \
        "setenv jh_clk clk_ignore_unused; " \
               "if run loadimage; then " \
                   "run mmcboot; " \
               "else run jh_netboot; fi; \0" \
    "jh_netboot=mw 0x303d0518 0xff; setenv fdt_file imx8mm-bse-root.dtb; setenv jh_clk clk_ignore_unused; run netboot; \0 "


#define CONFIG_MFG_ENV_SETTINGS \
    CONFIG_MFG_ENV_SETTINGS_DEFAULT \
    "initrd_addr=0x43C00000\0" \
...
#include "imx8mm_bse_android.h" /* TODO  need implement */
#endif
